...
public static class NGUIContextMenu
{
    ...
    private static void ShowHelp0( MenuCommand command ) { NGUIHelp.Show(); }

    [MenuItem( "Help/NGUI Support Forum" )]
    private static void ShowHelp01( MenuCommand command ) { Application.OpenURL( "http://www.tasharen.com/forum/index.php?board=1.0" ); }

    [MenuItem( "CONTEXT/UIWidget/Copy Widget" )]
    private static void CopyStyle( MenuCommand command ) { NGUISettings.CopyWidget( command.context as UIWidget ); }

    [MenuItem( "CONTEXT/UIWidget/Paste Widget Values" )]
    private static void PasteStyle( MenuCommand command ) { NGUISettings.PasteWidget( command.context as UIWidget, true ); }

    [MenuItem( "CONTEXT/UIWidget/Paste Widget Style" )]
    private static void PasteStyle2( MenuCommand command ) { NGUISettings.PasteWidget( command.context as UIWidget, false ); }

    [MenuItem( "CONTEXT/UIWidget/Help" )]
    private static void ShowHelp1( MenuCommand command ) { NGUIHelp.Show( command.context ); }

    [MenuItem( "CONTEXT/UIButton/Help" )]
    private static void ShowHelp2( MenuCommand command ) { NGUIHelp.Show( typeof( UIButton ) ); }

    [MenuItem( "CONTEXT/UIToggle/Help" )]
    private static void ShowHelp3( MenuCommand command ) { NGUIHelp.Show( typeof( UIToggle ) ); }

    [MenuItem( "CONTEXT/UIRoot/Help" )]
    private static void ShowHelp4( MenuCommand command ) { NGUIHelp.Show( typeof( UIRoot ) ); }

    [MenuItem( "CONTEXT/UICamera/Help" )]
    private static void ShowHelp5( MenuCommand command ) { NGUIHelp.Show( typeof( UICamera ) ); }

    [MenuItem( "CONTEXT/UIAnchor/Help" )]
    private static void ShowHelp6( MenuCommand command ) { NGUIHelp.Show( typeof( UIAnchor ) ); }

    [MenuItem( "CONTEXT/UIStretch/Help" )]
    private static void ShowHelp7( MenuCommand command ) { NGUIHelp.Show( typeof( UIStretch ) ); }

    [MenuItem( "CONTEXT/UISlider/Help" )]
    private static void ShowHelp8( MenuCommand command ) { NGUIHelp.Show( typeof( UISlider ) ); }

    [MenuItem( "CONTEXT/UI2DSprite/Help" )]
    private static void ShowHelp9( MenuCommand command ) { NGUIHelp.Show( typeof( UI2DSprite ) ); }

    [MenuItem( "CONTEXT/UIScrollBar/Help" )]
    private static void ShowHelp10( MenuCommand command ) { NGUIHelp.Show( typeof( UIScrollBar ) ); }

    [MenuItem( "CONTEXT/UIProgressBar/Help" )]
    private static void ShowHelp11( MenuCommand command ) { NGUIHelp.Show( typeof( UIProgressBar ) ); }

    [MenuItem( "CONTEXT/UIPopupList/Help" )]
    private static void ShowHelp12( MenuCommand command ) { NGUIHelp.Show( typeof( UIPopupList ) ); }

    [MenuItem( "CONTEXT/UIInput/Help" )]
    private static void ShowHelp13( MenuCommand command ) { NGUIHelp.Show( typeof( UIInput ) ); }

    [MenuItem( "CONTEXT/UIKeyBinding/Help" )]
    private static void ShowHelp14( MenuCommand command ) { NGUIHelp.Show( typeof( UIKeyBinding ) ); }

    [MenuItem( "CONTEXT/UIGrid/Help" )]
    private static void ShowHelp15( MenuCommand command ) { NGUIHelp.Show( typeof( UIGrid ) ); }

    [MenuItem( "CONTEXT/UITable/Help" )]
    private static void ShowHelp16( MenuCommand command ) { NGUIHelp.Show( typeof( UITable ) ); }

    [MenuItem( "CONTEXT/UIPlayTween/Help" )]
    private static void ShowHelp17( MenuCommand command ) { NGUIHelp.Show( typeof( UIPlayTween ) ); }

    [MenuItem( "CONTEXT/UIPlayAnimation/Help" )]
    private static void ShowHelp18( MenuCommand command ) { NGUIHelp.Show( typeof( UIPlayAnimation ) ); }

    [MenuItem( "CONTEXT/UIPlaySound/Help" )]
    private static void ShowHelp19( MenuCommand command ) { NGUIHelp.Show( typeof( UIPlaySound ) ); }

    [MenuItem( "CONTEXT/UIScrollView/Help" )]
    private static void ShowHelp20( MenuCommand command ) { NGUIHelp.Show( typeof( UIScrollView ) ); }

    [MenuItem( "CONTEXT/UIDragScrollView/Help" )]
    private static void ShowHelp21( MenuCommand command ) { NGUIHelp.Show( typeof( UIDragScrollView ) ); }

    [MenuItem( "CONTEXT/UICenterOnChild/Help" )]
    private static void ShowHelp22( MenuCommand command ) { NGUIHelp.Show( typeof( UICenterOnChild ) ); }

    [MenuItem( "CONTEXT/UICenterOnClick/Help" )]
    private static void ShowHelp23( MenuCommand command ) { NGUIHelp.Show( typeof( UICenterOnClick ) ); }

    [MenuItem( "CONTEXT/UITweener/Help" )]
    [MenuItem( "CONTEXT/UIPlayTween/Help" )]
    private static void ShowHelp24( MenuCommand command ) { NGUIHelp.Show( typeof( UITweener ) ); }

    [MenuItem( "CONTEXT/ActiveAnimation/Help" )]
    [MenuItem( "CONTEXT/UIPlayAnimation/Help" )]
    private static void ShowHelp25( MenuCommand command ) { NGUIHelp.Show( typeof( UIPlayAnimation ) ); }

    [MenuItem( "CONTEXT/UIScrollView/Help" )]
    [MenuItem( "CONTEXT/UIDragScrollView/Help" )]
    private static void ShowHelp26( MenuCommand command ) { NGUIHelp.Show( typeof( UIScrollView ) ); }

    [MenuItem( "CONTEXT/UIPanel/Help" )]
    private static void ShowHelp27( MenuCommand command ) { NGUIHelp.Show( typeof( UIPanel ) ); }

    [MenuItem( "CONTEXT/UILocalize/Help" )]
    private static void ShowHelp28( MenuCommand command ) { NGUIHelp.Show( typeof( UILocalize ) ); }

    [MenuItem( "CONTEXT/Localization/Help" )]
    private static void ShowHelp29( MenuCommand command ) { NGUIHelp.Show( typeof( Localization ) ); }

    [MenuItem( "CONTEXT/UIKeyNavigation/Help" )]
    private static void ShowHelp30( MenuCommand command ) { NGUIHelp.Show( typeof( UIKeyNavigation ) ); }

    [MenuItem( "CONTEXT/PropertyBinding/Help" )]
    private static void ShowHelp31( MenuCommand command ) { NGUIHelp.Show( typeof( PropertyBinding ) ); }
    ...
    private static void AttachCollider( object obj )
    {
    ...
    private static void Attach( object obj )
    {
    ...
    private static void AddMissingItem<T>( GameObject target, string name ) where T : MonoBehaviour
    {
    ...
    private static void AddChild<T>( object obj ) where T : MonoBehaviour
    {
    ...
    private static void AddPanel( object obj )
    {
        GameObject go = obj as GameObject;
    ...
    private static void AddScrollView( object obj )
    {
        GameObject go = obj as GameObject;
        if ( go.GetComponent<UIWidget>() != null ) go = go.transform.parent.gameObject;
        UIPanel panel = NGUISettings.AddPanel( go );
    ...
    private static void OnHelp( object obj )
    {
        NGUIHelp.Show( obj );
    }

    private static void OnMakePixelPerfect( object obj )
    {
        NGUITools.MakePixelPerfect( obj as Transform );
    }

    private static void OnBoxCollider( object obj )
    {
        NGUITools.AddWidgetCollider( obj as GameObject );
    }

    private static void OnDelete( object obj )
    {
        GameObject go = obj as GameObject;
