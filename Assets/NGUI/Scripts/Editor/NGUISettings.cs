...
public class NGUISettings
{
    ...
    #endregion Generic Get and Set methods
    ...
    #endregion Convenience accessor properties
    ...
    private static void CopySprite( UISprite sp )
    {
    ...
    private static void CopyLabel( UILabel lbl )
    {
    ...
    private static void PasteSprite( UISprite sp, bool fully )
    {
    ...
    private static void PasteLabel( UILabel lbl, bool fully )
    {
        if ( fully )
        {
