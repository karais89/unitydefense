...
{
    private const float SNAP_THRESHOLD = 10f;

    private static BetterList<Vector3> mSnapCenter = new BetterList<Vector3>();
    private static BetterList<Vector3> mSnapCorners = new BetterList<Vector3>();

    private static int mSnapping = -1;
    ...
    private static void Recalculate( Transform t )
    {
    ...
    private static void Add( Transform root, Transform child )
    {
    ...
    private static void Add( Transform root, Transform child, Vector3[] local )
    {
        // If the transform is rotated, ignore it
    ...
    private static void ChooseBest( ref Vector2 best, Vector3 diff )
    {
