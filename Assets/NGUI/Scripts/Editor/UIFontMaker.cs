...
public class UIFontMaker : EditorWindow
{
    ...
    private FontType mType = FontType.GeneratedBitmap;
    ...
    private void OnUnityFont( Object obj )
    {
    ...
    private static bool DrawOption( bool state, string text, params GUILayoutOption[] options )
    {
        GUILayout.BeginHorizontal();
        GUILayout.Space( 10f );
    ...
    private static void ImportFont( UIFont font, Create create, Material mat )
    {
        // New bitmap font
