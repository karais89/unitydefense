...
public class UIFontInspector : Editor
{
    ...
    private static View mView = View.Font;
    private static bool mUseShader = false;

    private UIFont mFont;
    private FontType mType = FontType.Bitmap;
    private UIFont mReplacement = null;
    private string mSymbolSequence = "";
    private string mSymbolSprite = "";
    private BMSymbol mSelectedSymbol = null;
    private AnimationCurve mCurve = new AnimationCurve( new Keyframe( 0f, 0f ), new Keyframe( 1f, 1f ) );
    ...
    private void SelectSymbolSprite( string spriteName )
    {
    ...
    private void ChangeSymbolSprite( string spriteName )
    {
    ...
    private void ApplyEffect( Effect effect, Color foreground, Color background )
    {
