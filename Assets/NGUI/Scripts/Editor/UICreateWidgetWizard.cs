...
public class UICreateWidgetWizard : EditorWindow
{
    ...
    private static WidgetType mWidgetType = WidgetType.Button;
    private static string mButton = "";
    private static string mImage0 = "";
    private static string mImage1 = "";
    private static string mImage2 = "";
    private static string mImage3 = "";
    private static string mSliderBG = "";
    private static string mSliderFG = "";
    private static string mSliderTB = "";
    private static string mCheckBG = "";
    private static string mCheck = "";
    private static string mInputBG = "";
    private static string mListFG = "";
    private static string mListBG = "";
    private static string mListHL = "";
    private static string mScrollBG = "";
    private static string mScrollFG = "";
    private static Color mColor = Color.white;
    private static bool mLoaded = false;
    private static bool mScrollCL = true;
    private static UIScrollBar.FillDirection mFillDir = UIScrollBar.FillDirection.LeftToRight;

    /// <summary>
    /// Save the specified string into player prefs.
    /// </summary>

    private static void SaveString( string field, string val )
    {
    ...
    private static string LoadString( string field )
    {
        string s = EditorPrefs.GetString( field ); return ( string.IsNullOrEmpty( s ) ) ? "" : s;
    }
    ...
    private void CreateLabel( GameObject go )
    {
        GUILayout.BeginHorizontal();
    ...
    private void CreateSprite( GameObject go )
    {
    ...
    private void OnSprite( string val )
    {
    ...
    private void CreateSimpleTexture( GameObject go )
    {
    ...
    private void CreateImageButton( GameObject go )
    {
        if ( NGUISettings.atlas != null )
        {
    ...
    private void OnImage0( string val )
    {
        mImage0 = val; Save(); Repaint();
    }

    private void OnImage1( string val )
    {
        mImage1 = val; Save(); Repaint();
    }

    private void OnImage2( string val )
    {
        mImage2 = val; Save(); Repaint();
    }

    private void OnImage3( string val )
    {
        mImage3 = val; Save(); Repaint();
    }
    ...
    private void CreateToggle( GameObject go )
    {
        if ( NGUISettings.atlas != null )
        {
    ...
    private void OnCheckBG( string val )
    {
        mCheckBG = val; Save(); Repaint();
    }

    private void OnCheck( string val )
    {
        mCheck = val; Save(); Repaint();
    }
    ...
    private void CreateScrollBar( GameObject go )
    {
        if ( NGUISettings.atlas != null )
        {
    ...
    private void OnScrollBG( string val )
    {
        mScrollBG = val; Save(); Repaint();
    }

    private void OnScrollFG( string val )
    {
        mScrollFG = val; Save(); Repaint();
    }
    ...
    private void CreateSlider( GameObject go, bool slider )
    {
        if ( NGUISettings.atlas != null )
        {
    ...
    private void OnSliderBG( string val )
    {
        mSliderBG = val; Save(); Repaint();
    }

    private void OnSliderFG( string val )
    {
        mSliderFG = val; Save(); Repaint();
    }

    private void OnSliderTB( string val )
    {
        mSliderTB = val; Save(); Repaint();
    }
    ...
    private void CreateInput( GameObject go )
    {
        if ( NGUISettings.atlas != null )
        {
    ...
    private void OnInputBG( string val )
    {
        mInputBG = val; Save(); Repaint();
    }
    ...
    private void CreatePopup( GameObject go, bool isDropDown )
    {
        if ( NGUISettings.atlas != null )
        {
    ...
    private void OnListFG( string val )
    {
        mListFG = val; Save(); Repaint();
    }

    private void OnListBG( string val )
    {
        mListBG = val; Save(); Repaint();
    }

    private void OnListHL( string val )
    {
        mListHL = val; Save(); Repaint();
    }
...
#if DYNAMIC_FONT
    private UILabelInspector.FontType mType = UILabelInspector.FontType.Unity;
#else
	UILabelInspector.FontType mType = UILabelInspector.FontType.Unity;
#endif

    private void OnFont( Object obj )
    {
