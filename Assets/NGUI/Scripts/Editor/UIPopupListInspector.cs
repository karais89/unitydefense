...
public class UIPopupListInspector : UIWidgetContainerEditor
{
    ...
    private void OnBackground( string spriteName )
    {
        RegisterUndo();
    ...
    private void OnHighlight( string spriteName )
    {
        RegisterUndo();
    ...
    private void OnBitmapFont( Object obj )
    {
    ...
    private void OnDynamicFont( Object obj )
    {
        serializedObject.Update();
