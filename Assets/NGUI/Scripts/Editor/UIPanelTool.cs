...
public class UIPanelTool : EditorWindow
{
    ...
    private static List<UIPanel> GetListOfPanels()
    {
    ...
    private static void GetWidgets( Transform t, List<UIWidget> widgets )
    {
    ...
    private static List<UIWidget> GetWidgets( UIPanel panel )
    {
    ...
    private bool DrawRow( Entry ent, UIPanel selected, bool isChecked )
    {
        bool retVal = false;
