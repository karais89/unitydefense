...
public class UIPrefabTool : EditorWindow
{
    ...
    private int cellSize { get { return ( mMode == Mode.CompactMode ) ? 50 : 80; } }

    private int mTab = 0;
    private Mode mMode = Mode.IconMode;
    ...
    private string saveKey { get { return "NGUI " + Application.dataPath + " " + mTab; } }
    ...
    private void DestroyTexture( Item item )
    {
    ...
    private static Texture2D LoadPreview( Item item )
    {
    ...
    private void GeneratePreview( Item item, UISnapshotPoint point )
    {
    ...
    private static bool SetupPreviewForUI( Camera cam, GameObject root, GameObject child, UISnapshotPoint point )
    {
    ...
    private static bool SetupPreviewFor3D( Camera cam, GameObject root, GameObject child, UISnapshotPoint point )
    {
    ...
    private static void SetupSnapshotCamera( GameObject go, Camera cam, UISnapshotPoint point )
    {
    ...
    private static void SetupSnapshotCamera( GameObject go, Camera cam, float objectSize, float orthoSize, float near, float far )
    {
    ...
    private static Transform FindChild( Transform t, string startsWith )
    {
