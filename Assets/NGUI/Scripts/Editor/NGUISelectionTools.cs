...
public class NGUISelectionTools
{
    ...
    private static void ClearLocalTransform()
    {
        if ( HasValidTransform() )
        {
    ...
    private static bool HasValidTransform()
    {
        if ( Selection.activeTransform == null )
        {
            Debug.LogWarning( "You must select an object first" );
    ...
    private static bool PrefabCheck()
    {
        if ( Selection.activeTransform != null )
        {
    ...
    private static List<AssetEntry> GetDependencyList( Object[] objects, bool reverse )
    {
    ...
    private static string GetDependencyText( Object[] objects, bool reverse )
    {
