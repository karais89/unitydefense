...
public class UIWidgetInspector : UIRectEditor
{
    ...
    private Action mActionUnderMouse = Action.None;
    private bool mAllowSelection = true;

    protected UIWidget mWidget;

    static protected bool mUseShader = false;
    private static GUIStyle mBlueDot = null;
    private static GUIStyle mYellowDot = null;
    private static GUIStyle mRedDot = null;
    private static GUIStyle mOrangeDot = null;
    private static GUIStyle mGreenDot = null;
    private static GUIStyle mGreyDot = null;
    private static MouseCursor mCursor = MouseCursor.Arrow;
    ...
    private Vector3 mLocalPos = Vector3.zero;
    private Vector3 mWorldPos = Vector3.zero;
    private int mStartWidth = 0;
    private int mStartHeight = 0;
    private Vector3 mStartDrag = Vector3.zero;
    private Vector2 mStartMouse = Vector2.zero;
    private Vector3 mStartRot = Vector3.zero;
    private Vector3 mStartDir = Vector3.right;
    private Vector2 mStartLeft = Vector2.zero;
    private Vector2 mStartRight = Vector2.zero;
    private Vector2 mStartBottom = Vector2.zero;
    private Vector2 mStartTop = Vector2.zero;
    private UIWidget.Pivot mDragPivot = UIWidget.Pivot.Center;
    ...
    private static void DrawDimensions( SerializedObject so, UIWidget w, bool isPrefab )
    {
        GUILayout.BeginHorizontal();
        {
    ...
    private static void DrawDepth( SerializedObject so, UIWidget w, bool isPrefab )
    {
        if ( isPrefab ) return;
    ...
    private static void DrawPivot( SerializedObject so, UIWidget w )
    {
    ...
    private static void Toggle( UIWidget w, string text, string style, UIWidget.Pivot pivot, bool isHorizontal )
    {
        bool isActive = false;
    ...
    private static bool IsLeft( UIWidget.Pivot pivot )
    {
    ...
    private static bool IsRight( UIWidget.Pivot pivot )
    {
    ...
    private static bool IsTop( UIWidget.Pivot pivot )
    {
    ...
    private static bool IsBottom( UIWidget.Pivot pivot )
    {
    ...
    private static UIWidget.Pivot GetHorizontal( UIWidget.Pivot pivot )
    {
    ...
    private static UIWidget.Pivot GetVertical( UIWidget.Pivot pivot )
    {
    ...
    private static UIWidget.Pivot Combine( UIWidget.Pivot horizontal, UIWidget.Pivot vertical )
    {
    ...
    private static void SetPivot( UIWidget w, UIWidget.Pivot pivot, bool isHorizontal )
    {
