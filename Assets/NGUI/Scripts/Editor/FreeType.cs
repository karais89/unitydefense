...
static public class FreeType
{
    ...
    private static bool mFound = false;
    ...
    [DllImport( libName, CallingConvention = CallingConvention.Cdecl )]
    private static extern int FT_New_Face( IntPtr library, string filepathname, int face_index, out IntPtr face );
    ...
    [DllImport( libName, CallingConvention = CallingConvention.Cdecl )]
    private static extern int FT_Render_Glyph( ref FT_GlyphSlotRec slot, FT_Render_Mode render_mode );
    ...
    [DllImport( libName, CallingConvention = CallingConvention.Cdecl )]
    private static extern int FT_Get_Kerning( IntPtr face, uint left, uint right, uint kern_mode, out FT_Vector kerning );
    ...
    [DllImport( libName, CallingConvention = CallingConvention.Cdecl )]
    private static extern int FT_Done_FreeType( IntPtr library );
