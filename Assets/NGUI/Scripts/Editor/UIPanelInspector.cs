...
{
    private static int s_Hash = "PanelHash".GetHashCode();

    private UIPanel mPanel;
    private UIWidgetInspector.Action mAction = UIWidgetInspector.Action.None;
    private UIWidgetInspector.Action mActionUnderMouse = UIWidgetInspector.Action.None;
    private bool mAllowSelection = true;

    private Vector3 mLocalPos = Vector3.zero;
    private Vector3 mWorldPos = Vector3.zero;
    private Vector4 mStartCR = Vector4.zero;
    ...
    private GUIStyle mStyle0 = null;
    private GUIStyle mStyle1 = null;
    ...
    private void DrawKnob( Vector4 point, int id, bool canResize )
    {
    ...
    private void AdjustClipping( UIPanel p, Vector3 startLocalPos, Vector4 startCR, Vector3 worldDelta, UIWidget.Pivot pivot )
    {
    ...
    private void AdjustClipping( UIPanel p, Vector4 cr, int left, int top, int right, int bottom )
    {
