...
public class UIAtlasMaker : EditorWindow
{
    ...
    private List<Texture> GetSelectedTextures()
    {
    ...
    private static List<Texture2D> LoadTextures( List<Texture> textures )
    {
    ...
    private static bool PackTextures( Texture2D tex, List<SpriteEntry> sprites )
    {
    ...
    private Dictionary<string, int> GetSpriteList( List<Texture> textures )
    {
    ...
    private static SpriteEntry ExtractSprite( UISpriteData es, Texture2D tex )
    {
    ...
    private static SpriteEntry ExtractSprite( UISpriteData es, Color32[] oldPixels, int oldWidth, int oldHeight )
    {
    ...
    private void UpdateAtlas( List<Texture> textures, bool keepSprites )
    {
