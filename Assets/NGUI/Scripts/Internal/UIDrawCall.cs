...
public class UIDrawCall : MonoBehaviour
{
    ...
    private Material mMaterial;		// Material used by this screen
    ...
    private int mClipCount = 0;	// Number of times the draw call's content is getting clipped
...
#else
    private static List<int[]> mCache = new List<int[]>( maxIndexBufferCache );
#endif
