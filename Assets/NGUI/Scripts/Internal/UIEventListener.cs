...
public class UIEventListener : MonoBehaviour
{
    ...
    {
        if ( onHover != null ) onHover( gameObject, isOver );
    }
    ...
    {
        if ( onScroll != null ) onScroll( gameObject, delta );
    }
    ...
    {
        if ( onDragOver != null ) onDragOver( gameObject );
    }
    ...
    {
        if ( onDrop != null ) onDrop( gameObject, go );
    }

    private void OnKey( KeyCode key )
    {
        if ( onKey != null ) onKey( gameObject, key );
    }
